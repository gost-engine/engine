...
int main(void)
{
    ...
    const unsigned char meshed_key[] = {
        0x86, 0x3E, 0xA0, 0x17, 0x84, 0x2C, 0x3D, 0x37, 0x2B, 0x18, 0xA8,
        0x5A, 0x28, 0xE2, 0x31, 0x7D, 0x74, 0xBE, 0xFC, 0x10, 0x77, 0x20,
        0xDE, 0x0C, 0x9E, 0x8A, 0xB9, 0x74, 0xAB, 0xD0, 0x0C, 0xA0,
    };
