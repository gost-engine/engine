...
const unsigned char gh_pdata[67] = {
    ...
    0xFF, 0x0A, 0x00, 0x11, 0xAA, 0xBB, 0xCC};

const unsigned char gh_e_cdata[67] = {
    0xA9, 0x75, 0x7B, 0x81, 0x47, 0x95, 0x6E, 0x90, 0x55, 0xB8, 0xA3, 0x3D,
    0xE8, 0x9F, 0x42, 0xFC, 0x80, 0x75, 0xD2, 0x21, 0x2B, 0xF9, 0xFD, 0x5B,
    0xD3, 0xF7, 0x06, 0x9A, 0xAD, 0xC1, 0x6B, 0x39, 0x49, 0x7A, 0xB1, 0x59,
    0x15, 0xA6, 0xBA, 0x85, 0x93, 0x6B, 0x5D, 0x0E, 0xA9, 0xF6, 0x85, 0x1C,
...
const unsigned char mg_pdata[67] = {
    ...
    0x55, 0x66, 0x77, 0x00, 0x88, 0x99, 0xaa, 0xbb, 0xcc, 0xee, 0xFF, 0x0A,
    0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x99, 0xaa, 0xbb, 0xcc,
    0xee, 0xFF, 0x0a, 0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88,
    0xaa, 0xbb, 0xcc, 0xee, 0xFF, 0x0a, 0x00, 0x11, 0x22, 0x33, 0x44, 0x55,
    0x66, 0x77, 0x88, 0x99, 0xaa, 0xbb, 0xcc};

const unsigned char mg_e_cdata[67] = {
    0xc7, 0x95, 0x06, 0x6c, 0x5f, 0x9e, 0xa0, 0x3b, 0x85, 0x11, 0x33, 0x42,
    0x45, 0x91, 0x85, 0xae, 0x1f, 0x2e, 0x00, 0xd6, 0xbf, 0x2b, 0x78, 0x5d,
    0x94, 0x04, 0x70, 0xb8, 0xbb, 0x9c, 0x8e, 0x7d, 0x9a, 0x5d, 0xd3, 0x73,
    0x1f, 0x7d, 0xdc, 0x70, 0xec, 0x27, 0xcb, 0x0a, 0xce, 0x6f, 0xa5, 0x76,
    0x70, 0xf6, 0x5c, 0x64, 0x6a, 0xbb, 0x75, 0xd5, 0x47, 0xaa, 0x37, 0xc3,
    0xbc, 0xb5, 0xc3, 0x4e, 0x03, 0xbb, 0x9c};
    ...
    const unsigned char *exp_tag, const unsigned char *key, int small)
{
    ...
    TEST_ASSERT(outlen1 != alen || outlen2 != plen || memcmp(c, exp_ctext, plen)
    ...
    TEST_ASSERT(outlen1 != alen || outlen2 != plen || memcmp(c, ptext, plen)
                || rv != 1);
    ret |= test;
