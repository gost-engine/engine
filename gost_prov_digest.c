...
const OSSL_ALGORITHM GOST_prov_digests[] = {
     ...
     */
    { "id-tc26-gost3411-12-256:md_gost12_256:1.2.643.7.1.1.2.2", "provider=gost",
      GostR3411_2012_256_digest_functions,
      "GOST R 34.11-2012 with 256 bit hash" },
    { "id-tc26-gost3411-12-512:md_gost12_512:1.2.643.7.1.1.2.3", "provider=gost",
    ...
    { "id-GostR3411-94:md_gost94:1.2.643.2.2.9", "provider=gost",
