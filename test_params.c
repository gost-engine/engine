...
const uint8_t data_2001_256_setA[] = {
    0xCB, 0x03, 0xB7, 0x57, 0xBC, 0xA7, 0xBC, 0xB6, 0xB0, 0x37,
    0xC5, 0xD4, 0xBB, 0x51, 0x52, 0x9A, 0xEE, 0xF3, 0x28, 0x9B,
    0x14, 0x11, 0xE2, 0xCB, 0xAB, 0x82, 0x1A, 0xDF, 0x1D, 0x2A,
    0x70, 0xE6, 0x09, 0x1B, 0x7C, 0xE9, 0x6D, 0xAE, 0xAF, 0xF9,
};

static uint8_t hash_2001_256_setA[] = {
    0x4F, 0x49, 0xB3, 0x9E, 0xA0, 0x06, 0xD0, 0xDA, 0x4D, 0x81, 0x50,
    0x61, 0x08, 0x66, 0xA1, 0x18, 0xA6, 0x04, 0x25, 0x98, 0xB9, 0x66,
    0x00, 0x32, 0xC5, 0x40, 0xD6, 0xEB, 0x1A, 0x85, 0x70, 0xEE,
};

static uint8_t signature_2001_256_setA[] = {
    0x7E, 0xE2, 0x99, 0xB9, 0x50, 0x78, 0x1C, 0xE4, 0xDC, 0xA6, 0x68,
    0xCF, 0x6E, 0x88, 0xDC, 0x29, 0x3F, 0x13, 0x8F, 0x12, 0x14, 0x1A,
    0x03, 0x3A, 0x09, 0x01, 0x78, 0x52, 0x82, 0x7D, 0xDC, 0x7B, 0xF0,
    0xE5, 0x49, 0x93, 0x9D, 0xBF, 0x95, 0x4B, 0xB4, 0xB1, 0x40, 0x72,
    0xDE, 0x15, 0x86, 0x11, 0x1D, 0xF9, 0x63, 0xF2, 0xE7, 0xEF, 0xB7,
    0xBD, 0x73, 0xF7, 0xB7, 0xD1, 0x95, 0x61, 0xBA, 0x1C,
};

static uint8_t pubkey_2001_256_setA[] = {
    0xF0, 0x69, 0xAF, 0x90, 0xEE, 0xE4, 0xA3, 0x33, 0x52, 0xA2, 0xE8,
    0x0C, 0x72, 0xE6, 0x20, 0xAF, 0xB7, 0x66, 0x03, 0xE5, 0xFF, 0x85,
    0xF3, 0xAA, 0x5F, 0x38, 0x2F, 0x8E, 0x44, 0xEF, 0x51, 0x0F, 0x82,
    0x59, 0x4A, 0x99, 0x10, 0xB8, 0x89, 0xCD, 0x78, 0xD2, 0xBA, 0xF1,
    0x97, 0xFE, 0xEB, 0xE6, 0x74, 0xC1, 0x96, 0x90, 0x97, 0x71, 0xAD,
    0x16, 0x9F, 0x9B, 0x37, 0xDD, 0x2B, 0x44, 0xFF, 0x2D,
};

/* 1.2.643.2.2.35.2 - szOID_GostR3410_2001_CryptoPro_B_ParamSet */
const uint8_t data_2001_256_setB[] = {0x54, 0x7D, 0x31, 0xFE, 0x69, 0xD4, 0xB1,
                                      0x58, 0x7E, 0x34, 0x2D, 0xC9, 0x3D, 0xBD,
                                      0x67, 0xAF, 0xD8, 0x31, 0x90, 0xC4, 0xA9,
                                      0x07, 0xCE, 0x34, 0x3F, 0x90, 0x3A, 0xC4,
                                      0xFC, 0xE4, 0x4E, 0xEA, 0xF1, 0xE9, 0x04,
                                      0xD0, 0x7E, 0x4B, 0xCF, 0x39};

const uint8_t hash_2001_256_setB[] = {
    0x10, 0xDE, 0x3D, 0x7A, 0xEE, 0x6E, 0xC0, 0x0D, 0x57, 0x9B, 0x4B,
    0xB2, 0x92, 0xB8, 0xE5, 0x4E, 0x75, 0x19, 0x92, 0xFE, 0x71, 0x91,
    0xF7, 0xF2, 0x72, 0xE7, 0x77, 0x47, 0x51, 0xF7, 0xEC, 0x26,
};

const uint8_t signature_2001_256_setB[] = {
    0x9C, 0x27, 0x76, 0x22, 0xB8, 0x4A, 0xB6, 0x2B, 0xBA, 0x2E, 0xE3,
    0xD5, 0x89, 0x72, 0x89, 0x53, 0x7C, 0x2D, 0xB7, 0x70, 0x8A, 0xD5,
    0x7B, 0x61, 0xDF, 0xD1, 0xD6, 0x7F, 0x77, 0xFF, 0xDB, 0x4E, 0xEE,
    0x98, 0xFC, 0x2C, 0xDE, 0xAA, 0xC7, 0xDE, 0x42, 0xEE, 0x40, 0x12,
    0x5E, 0xC8, 0xFE, 0x0E, 0x97, 0x80, 0xB9, 0x6A, 0xAC, 0x93, 0xAD,
    0xEE, 0x96, 0xE1, 0xDB, 0xC6, 0xF2, 0xAC, 0xF4, 0x22};

const uint8_t pubkey_2001_256_setB[] = {
    0x6A, 0x8A, 0x5E, 0x32, 0x00, 0xED, 0xD3, 0xA7, 0x38, 0x83, 0x58,
    0x7D, 0xBD, 0xE9, 0xFD, 0xA9, 0x00, 0xAE, 0xE8, 0x4F, 0xFF, 0x71,
    0xD2, 0xA0, 0x79, 0x14, 0xD4, 0xB4, 0xB2, 0x00, 0x9A, 0x0A, 0x51,
    0x21, 0xD5, 0x19, 0x05, 0xF1, 0xB7, 0x6C, 0x2E, 0x3A, 0x18, 0xDD,
    0x82, 0x67, 0x7F, 0x96, 0x0B, 0x1A, 0x76, 0x93, 0xF7, 0x6A, 0xCA,
    0x15, 0xCD, 0xEE, 0xA1, 0xD2, 0xDE, 0xD5, 0x56, 0x20};

/* 1.2.643.2.2.35.3 - szOID_GostR3410_2001_CryptoPro_C_ParamSet */
const uint8_t data_2001_256_setC[] = {0x30, 0x26, 0xBB, 0x7C, 0xEE, 0x71, 0x15,
                                      0xF6, 0x01, 0x3B, 0x8E, 0xF9, 0x04, 0xA7,
                                      0x02, 0x39, 0xC7, 0xF2, 0xDC, 0x15, 0x2C,
                                      0xB4, 0x95, 0x74, 0x1B, 0x66, 0x78, 0x5A,
                                      0x0F, 0xF1, 0x88, 0x5A, 0x68, 0x7F, 0xD2,
                                      0xE8, 0xF3, 0x85, 0xE2, 0xD5};

const uint8_t hash_2001_256_setC[] = {0x8C, 0xFE, 0x45, 0xBD, 0x4F, 0x9D, 0xEB,
                                      0x80, 0x78, 0xA7, 0xA3, 0xFB, 0xB3, 0x06,
                                      0x2A, 0xE4, 0xD6, 0xF4, 0x1A, 0x0B, 0x31,
                                      0xEB, 0x82, 0xB8, 0x13, 0x32, 0xD6, 0xA2,
                                      0xAE, 0x80, 0xF1, 0xF7};

const uint8_t signature_2001_256_setC[] = {
    0xD3, 0x16, 0xBB, 0x65, 0x48, 0x6D, 0x2D, 0x55, 0x14, 0x13, 0xAE,
    0x20, 0x31, 0x2B, 0xA5, 0x6B, 0x32, 0x56, 0x0C, 0xCF, 0xB3, 0x48,
    0x59, 0x63, 0x3C, 0x8F, 0xD6, 0x98, 0x9D, 0x88, 0xB1, 0x34, 0xAB,
    0xBD, 0x04, 0x39, 0x66, 0xE5, 0x9D, 0x63, 0xAA, 0xAB, 0x63, 0x98,
    0x6C, 0x06, 0x54, 0xC2, 0xDB, 0xD0, 0x6A, 0x6E, 0x57, 0xB3, 0x23,
    0x41, 0xAB, 0x22, 0xBB, 0x13, 0x37, 0x18, 0x3E, 0x08};

const uint8_t pubkey_2001_256_setC[] = {
    0xBA, 0x43, 0xE0, 0xF4, 0x0D, 0x3E, 0x50, 0x60, 0xCE, 0xC7, 0xE7,
    0x0C, 0x34, 0x8F, 0x21, 0x22, 0xF4, 0x36, 0x7E, 0x0E, 0x35, 0x49,
    0x92, 0x66, 0x89, 0x92, 0x0B, 0x62, 0x37, 0xF8, 0x69, 0x82, 0xB7,
    0x0E, 0x32, 0x29, 0x5F, 0xD6, 0x44, 0x56, 0xBB, 0x16, 0xD0, 0x8D,
    0x3B, 0xE5, 0xC2, 0xB5, 0xCE, 0x99, 0x4D, 0xDD, 0x41, 0xF9, 0xE7,
    0x98, 0x14, 0xBD, 0xC5, 0x87, 0xAE, 0x8D, 0xF1, 0x25};

/* 1.2.643.7.1.2.1.1.1 - szOID_tc26_gost_3410_12_256_paramSetA */
const uint8_t data_tc26_gost_3410_12_256_setA[] = {
    0xBF, 0xA5, 0x7B, 0x70, 0x8F, 0x4D, 0xDE, 0x9A, 0x38, 0x5A, 0x4A,
    0xA5, 0xD9, 0xDB, 0x84, 0x6A, 0x23, 0xD8, 0xB4, 0x73, 0x1E, 0x9A,
    0x55, 0x42, 0x32, 0x85, 0x28, 0xE8, 0x2B, 0x0D, 0x83, 0x0E, 0x06,
    0xBF, 0x46, 0x99, 0x38, 0xDF, 0xB4, 0xFA, 0x08, 0x0D, 0x5B, 0x20,
    0xEC, 0x0D, 0xD9, 0x7F, 0x7C, 0x69, 0x51, 0xDA, 0xA5, 0x50, 0x2A,
    0x65, 0xFD, 0xB1, 0x1F, 0x88, 0xCB, 0xA6, 0xE2, 0x61};

const uint8_t hash_tc26_gost_3410_12_256_setA[] = {
    0xFD, 0x39, 0xEA, 0x88, 0x90, 0x89, 0xD8, 0x1E, 0xE2, 0x49, 0x11,
    0xDB, 0x51, 0x71, 0x48, 0x0A, 0xD7, 0x27, 0xCC, 0xBA, 0xD2, 0x19,
    0xF4, 0x9E, 0x98, 0xC6, 0x3D, 0x1F, 0xB5, 0x7C, 0x24, 0x2F};

const uint8_t signature_tc26_gost_3410_12_256_setA[] = {
    0x0D, 0xC4, 0xCA, 0x98, 0x2B, 0x15, 0x51, 0xD4, 0x74, 0x36, 0x24,
    0x10, 0xEA, 0x21, 0x2D, 0x8E, 0xBB, 0x6C, 0xBB, 0x5E, 0xE5, 0x26,
    0x76, 0x3D, 0x88, 0x62, 0xC5, 0x2B, 0x5F, 0x93, 0xF9, 0x01, 0x46,
    0x49, 0xD6, 0x0F, 0x30, 0x44, 0x45, 0x55, 0x0B, 0xC6, 0x63, 0x60,
    0x20, 0x26, 0x09, 0x08, 0x85, 0x2E, 0x16, 0xBE, 0x14, 0x46, 0x31,
    0x89, 0xA6, 0xD3, 0x52, 0xBA, 0xD5, 0x51, 0x69, 0x24};

const uint8_t pubkey_tc26_gost_3410_12_256_setA[] = {
    0x3B, 0x8A, 0x6A, 0x5E, 0xFE, 0x62, 0x30, 0x31, 0x3A, 0x34, 0x9A,
    0x6A, 0xF0, 0xC4, 0x92, 0x4E, 0xF4, 0xF8, 0x0E, 0xF6, 0xE1, 0xF2,
    0x3F, 0xE1, 0x9A, 0xA9, 0x7A, 0x77, 0x97, 0x3A, 0x11, 0xE8, 0xD2,
    0xA8, 0x5F, 0xD1, 0x49, 0xE0, 0xBD, 0xAB, 0x28, 0xD5, 0x2B, 0x02,
    0x06, 0x99, 0x8E, 0x7E, 0xFF, 0xDB, 0x2A, 0xDE, 0x92, 0x11, 0x34,
    0x5D, 0xCF, 0x40, 0xEE, 0x0B, 0xD0, 0x61, 0x89, 0x75};

/* 1.2.643.7.1.2.1.2.1 - szOID_tc26_gost_3410_12_512_paramSetA */
const uint8_t data_tc26_gost_3410_12_512_setA[] = {
    0xEF, 0x15, 0x1E, 0x5B, 0xE9, 0x52, 0x35, 0x84, 0x17, 0x07, 0x4B,
    0xBD, 0x10, 0xEA, 0x7D, 0x77, 0x1E, 0xBF, 0x95, 0x55, 0xA4, 0x2A,
    0x8F, 0xA7, 0xFF, 0x3F, 0xEC, 0x8F, 0xA2, 0x3C, 0x90, 0x65, 0x4A,
    0xB8, 0x59, 0x31, 0xE1, 0x97, 0xD5, 0xC4, 0x26, 0x49, 0xCE, 0x81,
    0x53, 0xBE, 0x79, 0xF7, 0xA1, 0xB2, 0xE0, 0x7D, 0x44, 0xA4, 0x74,
    0x64, 0xB0, 0x09, 0x62, 0x35, 0xC5, 0x50, 0x7F, 0x36};

const uint8_t hash_tc26_gost_3410_12_512_setA[] = {
    0xE9, 0x25, 0x04, 0x72, 0x12, 0xC3, 0x82, 0x06, 0x00, 0xB6, 0x76,
    0xF4, 0x4D, 0x71, 0xE4, 0x42, 0x49, 0x3E, 0x57, 0x23, 0xBF, 0xBD,
    0xBF, 0x94, 0x7C, 0x0E, 0x2D, 0xAA, 0x48, 0x36, 0xF5, 0x9A, 0x4D,
    0x66, 0x02, 0x42, 0x0E, 0xCC, 0x94, 0xDF, 0x7D, 0x21, 0xF8, 0x69,
    0x1D, 0xFD, 0x45, 0x56, 0x42, 0x4C, 0x69, 0x17, 0x8E, 0x21, 0xBE,
    0x4F, 0x2C, 0xC8, 0x61, 0xDB, 0xA7, 0x24, 0xEC, 0x48};

const uint8_t signature_tc26_gost_3410_12_512_setA[] = {
    };

const uint8_t pubkey_tc26_gost_3410_12_512_setA[] = {
    0xB2, 0xBF, 0x45, 0x23, 0x00, 0x57, 0x70, 0xAE, 0xAB, 0x5B, 0x63, 0xEC,
    0xA8, 0x5F, 0xCF, 0xD0, 0xBA, 0x88, 0x64, 0x79, 0x3D, 0xB6, 0x70, 0x88,
    0xE8, 0xD8, 0xA4, 0x95, 0x9E, 0xB9, 0x78, 0x73, 0x9F, 0x0A, 0x34, 0x74,
    0xED, 0xFF, 0xB9, 0x7E, 0x34, 0x1B, 0xE0, 0x2A, 0xE2, 0xD8, 0x07, 0xE9,
    0xC2, 0xD2, 0x84, 0x39, 0x9E, 0x36, 0x0F, 0x7A, 0xE2, 0x56, 0x2A, 0x81,
    0x6C, 0x94, 0x9D, 0x5E, 0x6E, 0x68, 0x94, 0xFD, 0x75, 0x14, 0xE5, 0x07,
    0xED, 0x45, 0x2B, 0x07, 0xE1, 0xB2, 0x79, 0x2A, 0x21, 0x34, 0x21, 0x95,
    0x02, 0xF2, 0xAF, 0xDC, 0x8A, 0xD7, 0xA3, 0x72, 0x4C, 0x02, 0xA2, 0xF8,
    0x59, 0xE2, 0x91, 0x58, 0x01, 0x1D, 0x55, 0xC6, 0xEC, 0x73, 0xEA, 0x44,
    0x5B, 0x35, 0x08, 0x5C, 0xAC, 0xA0, 0xB9, 0x4B, 0x28, 0xE7, 0xBD, 0x8B,
...
const uint8_t data_tc26_gost_3410_12_512_setB[] = {
    0x84, 0x66, 0x52, 0x16, 0xB7, 0x53, 0xC0, 0xBB, 0xAE, 0xED, 0x2F,
    0x37, 0x78, 0x43, 0x03, 0xCF, 0x21, 0x5D, 0x36, 0x97, 0x55, 0x2B,
    0x3B, 0xF3, 0xFB, 0x9C, 0x18, 0x04, 0x81, 0x9B, 0x50, 0x9E, 0xBE,
    0xC1, 0x97, 0x53, 0xBC, 0xB1, 0x55, 0xDC, 0x0C, 0xAB, 0x7D, 0xB3,
    0x88, 0xBC, 0xB2, 0x9C, 0x86, 0x16, 0x21, 0x0A, 0x95, 0x9F, 0x3D,
    0xA6, 0x0C, 0xB4, 0x33, 0x1B, 0x7B, 0x29, 0xA3, 0x70, 0x1A, 0x67,
    0xD1, 0xC7, 0x45, 0xE7, 0xF6, 0xC0, 0x66};

const uint8_t hash_tc26_gost_3410_12_512_setB[] = {
    0x6A, 0x55, 0x15, 0x81, 0x50, 0x2A, 0x14, 0x22, 0x6F, 0xD1, 0x4B,
    0x50, 0xB1, 0xE2, 0x6C, 0x80, 0xC4, 0x84, 0x21, 0xF9, 0x63, 0x46,
    0xAF, 0xE8, 0xE0, 0x2C, 0xFD, 0x41, 0x1E, 0x49, 0x01, 0x6B, 0x00,
    0x3C, 0xEB, 0x5F, 0x6B, 0x34, 0xA9, 0x93, 0x2D, 0x86, 0x2F, 0xEA,
    0x58, 0x83, 0x81, 0x51, 0xF7, 0xA2, 0xCC, 0x0F, 0xAE, 0xAD, 0x40,
    0x65, 0x82, 0xC6, 0x53, 0x05, 0xAE, 0xEB, 0x22, 0xB8};

const uint8_t signature_tc26_gost_3410_12_512_setB[] = {
    };

const uint8_t pubkey_tc26_gost_3410_12_512_setB[] = {
    0x86, 0x97, 0xE7, 0x19, 0x03, 0x5E, 0x54, 0xA6, 0xE8, 0x7A, 0xEE, 0xD5,
    0x76, 0xC4, 0xC4, 0x72, 0x4A, 0x59, 0x55, 0xEB, 0x72, 0xF7, 0xE0, 0x62,
    0xB1, 0x0D, 0x1B, 0x79, 0x32, 0x72, 0x83, 0x0D, 0x1F, 0x7B, 0x74, 0x12,
    0x29, 0x20, 0xFD, 0x23, 0xAA, 0x8C, 0x77, 0xA1, 0x23, 0x38, 0x7F, 0x73,
    0x07, 0x94, 0x8A, 0x34, 0x46, 0xDB, 0x7C, 0xFB, 0x46, 0xF0, 0x63, 0xE9,
    0xD3, 0xAF, 0xC8, 0x4B, 0x78, 0x65, 0x99, 0xAE, 0x71, 0x7F, 0x45, 0xF8,
    0x7C, 0xF3, 0x0A, 0x2F, 0x97, 0xEB, 0x85, 0x1A, 0x22, 0x67, 0x65, 0x78,
    0xA5, 0xF8, 0xF2, 0x8C, 0xE8, 0xF5, 0x9B, 0x75, 0xA8, 0x3D, 0x81, 0xC1,
    0x7F, 0x69, 0x23, 0x94, 0xDE, 0x89, 0xFC, 0x65, 0xB3, 0xFE, 0x18, 0x91,
    0xC0, 0x03, 0xBE, 0xDA, 0xC8, 0x7D, 0x48, 0x12, 0x4F, 0x75, 0xC5, 0xAE,
...
const uint8_t data_tc26_gost_3410_12_512_setC[] = {
    0x40, 0xE2, 0xDD, 0x43, 0xF9, 0x59, 0x3C, 0xDC, 0x9C, 0x8F, 0x2E,
    0xBF, 0xA8, 0x0B, 0x2D, 0xD4, 0xB5, 0x00, 0x56, 0x93, 0xFC, 0xCE,
    0x73, 0x5B, 0x99, 0x66, 0x24, 0x0A, 0x76, 0x52, 0x2E, 0xBC, 0xBE,
    0xEA, 0x8A, 0x52, 0xFC, 0x95, 0x02, 0x8F, 0xB9, 0x8E, 0x23, 0x00,
    0x47, 0x40, 0x28, 0xE4, 0x92, 0x9C, 0x19, 0x99, 0xBD, 0x98, 0xF5,
    0x3A, 0xA0, 0xBE, 0xFB, 0xC7, 0xC1, 0xE3, 0x98, 0x6B, 0x8D, 0x2F,
    0x5A, 0x85, 0xB9, 0x46, 0x90, 0x83, 0x6D};

const uint8_t hash_tc26_gost_3410_12_512_setC[] = {
    0xBD, 0x82, 0xF1, 0x34, 0x33, 0x74, 0x9C, 0xC2, 0x9E, 0x95, 0x67,
    0x57, 0x2C, 0x6D, 0x83, 0x3D, 0xFD, 0xBD, 0x7C, 0xD7, 0xAA, 0xE7,
    0x28, 0xF9, 0x81, 0xB9, 0xCF, 0xAE, 0x4A, 0xAA, 0x17, 0x7D, 0x84,
    0x79, 0x25, 0xC5, 0x66, 0xAA, 0x9E, 0x28, 0x66, 0x41, 0x95, 0xC4,
    0xFF, 0xF6, 0x72, 0xEF, 0x0E, 0x08, 0xC6, 0x0B, 0x2E, 0x0F, 0xCB,
    0xC6, 0x96, 0x4A, 0x77, 0x0D, 0x14, 0xE5, 0x35, 0xC0};

const uint8_t signature_tc26_gost_3410_12_512_setC[] = {
    };

const uint8_t pubkey_tc26_gost_3410_12_512_setC[] = {
    0xA9, 0x85, 0x17, 0xF7, 0xFE, 0x1C, 0x43, 0x8A, 0xBE, 0xDE, 0x79, 0xE8,
    0x62, 0xFE, 0x51, 0x0E, 0xA7, 0xEA, 0x05, 0x46, 0x34, 0xD9, 0x54, 0x5B,
    0xFD, 0xB4, 0xC5, 0xCB, 0xA6, 0x9C, 0xFC, 0x90, 0x4B, 0x59, 0x14, 0xA1,
    0xE7, 0x2A, 0xDE, 0x2B, 0xB8, 0x86, 0x9E, 0xB5, 0xDB, 0xB3, 0xD3, 0xD7,
    0x95, 0x88, 0xCB, 0xEE, 0x33, 0x20, 0x82, 0xB2, 0xAC, 0xBF, 0x79, 0xDF,
    0x2E, 0x88, 0xF0, 0x5A, 0x62, 0x90, 0x26, 0x52, 0xAD, 0x64, 0x67, 0x36,
    0x1B, 0xE6, 0xCA, 0x57, 0x09, 0xEF, 0xF5, 0x56, 0x0E, 0x32, 0xDF, 0xB4,
    0x6C, 0xC8, 0xA8, 0xBB, 0xCB, 0x4C, 0xB4, 0xBA, 0x63, 0x41, 0xBA, 0x1D,
    0xAB, 0xB0, 0x12, 0x82, 0xFD, 0x50, 0x37, 0xDB, 0x69, 0x08, 0xF2, 0x7D,
    0x9E, 0xC0, 0xF7, 0xA6, 0xE9, 0x50, 0x26, 0x94, 0x88, 0x08, 0x5E, 0xDD,
...
static int EC_KEY_create(int type, int param_nid, EC_KEY *dst)
{
    ...
    T(EVP_PKEY_CTX_ctrl(
        ctx, type, -1, EVP_PKEY_CTRL_GOST_PARAMSET, param_nid, NULL));
    EVP_PKEY *pkey2 = NULL;
    int err;
