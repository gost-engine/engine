...
const OSSL_ALGORITHM GOST_prov_ciphers[] = {
    { SN_id_Gost28147_89 ":gost89:GOST 28147-89:1.2.643.2.2.21", "provider=gost",
      Gost28147_89_cipher_functions },
    { SN_gost89_cnt, "provider=gost", Gost28147_89_cnt_cipher_functions },
    { SN_gost89_cnt_12, "provider=gost", Gost28147_89_cnt_12_cipher_functions },
    { SN_gost89_cbc, "provider=gost", Gost28147_89_cbc_cipher_functions },
    { SN_grasshopper_ecb, "provider=gost", grasshopper_ecb_cipher_functions },
    { SN_grasshopper_cbc, "provider=gost", grasshopper_cbc_cipher_functions },
    { SN_grasshopper_cfb, "provider=gost", grasshopper_cfb_cipher_functions },
    { SN_grasshopper_ofb, "provider=gost", grasshopper_ofb_cipher_functions },
    { SN_grasshopper_ctr, "provider=gost", grasshopper_ctr_cipher_functions },
    { SN_magma_cbc, "provider=gost", magma_cbc_cipher_functions },
    { SN_magma_ctr, "provider=gost", magma_ctr_cipher_functions },
    { SN_magma_ctr_acpkm ":1.2.643.7.1.1.5.1.1", "provider=gost",
      magma_ctr_acpkm_cipher_functions },
    { SN_magma_ctr_acpkm_omac ":1.2.643.7.1.1.5.1.2", "provider=gost",
      magma_ctr_acpkm_omac_cipher_functions },
    { "magma-mgm", "provider=gost", magma_mgm_cipher_functions },
    { SN_kuznyechik_ctr_acpkm ":1.2.643.7.1.1.5.2.1", "provider=gost",
      grasshopper_ctr_acpkm_cipher_functions },
    { SN_kuznyechik_ctr_acpkm_omac ":1.2.643.7.1.1.5.2.2", "provider=gost",
      grasshopper_ctr_acpkm_omac_cipher_functions },
    { "kuznyechik-mgm", "provider=gost", grasshopper_mgm_cipher_functions },
