...
gost_subst_block GostR3411_94_CryptoProParamSet = {{0x1,
                                                    0x3,
                                                    0xA,
                                                    0x9,
                                                    0x5,
...
gost_subst_block Gost28147_TestParamSet = {{0xC,
                                            0x6,
                                            0x5,
                                            0x2,
                                            0xB,
...
/* 1.2.643.2.2.31.1 */
gost_subst_block Gost28147_CryptoProParamSetA = {{0xB,
                                                  0xA,
                                                  0xF,
                                                  0x5,
                                                  0x0,
...
/* 1.2.643.2.2.31.2 */
gost_subst_block Gost28147_CryptoProParamSetB = {{0x0,
                                                  0x4,
                                                  0xB,
                                                  0xE,
                                                  0x8,
...
/* 1.2.643.2.2.31.3 */
gost_subst_block Gost28147_CryptoProParamSetC = {{0x7,
                                                  0x4,
                                                  0x0,
                                                  0x5,
                                                  0xA,
...
/* 1.2.643.2.2.31.4 */
gost_subst_block Gost28147_CryptoProParamSetD = {{0x1,
                                                  0xA,
                                                  0x6,
                                                  0x8,
                                                  0xF,
...
/* 1.2.643.7.1.2.5.1.1 */
gost_subst_block Gost28147_TC26ParamSetZ = {{0x1,
                                             0x7,
                                             0xe,
                                             0xd,
                                             0x0,
...
const byte CryptoProKeyMeshingKey[] = {0x69, 0x00, 0x72, 0x22, 0x64, 0xC9, 0x04,
                                       0x23, 0x8D, 0x3A, 0xDB, 0x96, 0x46, 0xE9,
                                       0x2A, 0xC4, 0x18, 0xFE, 0xAC, 0x94, 0x00,
                                       0xED, 0x07, 0x12, 0xC0, 0x86, 0xDC, 0xC2,
                                       0xEF, 0x4C, 0xA9, 0x2B};
